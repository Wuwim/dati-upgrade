    ...
    <div class="set-bg">
      ...
      <div class="block3">
        ...
        <div class="block3-5">
          ...
          <div class="block4">
            <button v-if="finish" class="bt dati tijiao" @click="updates(time)">
              提交答案
            </button>
            <button v-else class="bt dati xiaoyiti" @click="goNext(time)">
              下一题
            </button>
          </div>
        </div>
...
export default {
  ...
  created() {
    this.getParams();
    let routerParams = this.$route.query.time;
